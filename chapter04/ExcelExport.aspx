...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grdProducts" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
            DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." OnRowDataBound="grdProducts_RowDataBound">
            <Columns>
                ...
                <asp:BoundField DataField="UnitPrice" ItemStyle-CssClass="excelCurrency" HeaderText="UnitPrice" SortExpression="UnitPrice" />
