...
public partial class Examples : System.Web.UI.Page
{
    ...
    protected void lnkTop20_Click(object sender, EventArgs e)
    {
        ...
        lblCode.Text = @"        Query qry = new Query(Product.Schema);
        qry.Top = &quot;20&quot;;
        GridView1.DataSource = qry.ExecuteReader();
        GridView1.DataBind();";
    }
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        lblCode.Text = @"        GridView1.DataSource = new ProductCollection()
    ...
    protected void LinkButton6_Click(object sender, EventArgs e) {
        ...
        lblCode.Text = @"        GridView1.DataSource = Product.Query().WHERE(&quot;CategoryID = 5&quot;)
    ...
    protected void LinkButton7_Click(object sender, EventArgs e) {
        ...
        lblCode.Text = @"        GridView1.DataSource = Product.Query().WHERE(&quot;UnitPrice > 20.00&quot;)
            .AND(&quot;CategoryID = 1&quot;)
            .OR(&quot;UnitPrice > 20.00&quot;)
